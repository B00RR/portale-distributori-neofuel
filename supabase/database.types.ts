...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      vouchers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "vouchers_shift_id_fkey"
            columns: ["shift_id"]
            isOneToOne: false
            referencedRelation: "shifts"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      can_manage_invoices: { Args: never; Returns: boolean }
      ...
      delete_shift_invoice: { Args: { p_invoice_id: number }; Returns: Json }
      finalize_daily_partial_shifts: { Args: never; Returns: Json }
      finalize_daily_partial_shifts_cron_guard: { Args: never; Returns: Json }
      get_current_user_id: { Args: never; Returns: number }
      get_current_user_role: { Args: never; Returns: string }
      get_daily_reconciliation: {
        Args: { p_date?: string; p_station_id: number }
        Returns: Json
      }
      ...
      get_shift_vouchers: {
        Args: { p_shift_id: number; p_station_id: number }
        Returns: {
          amount: number
          code: string
          id: string
      ...
      is_station_operator: { Args: { p_station_id: number }; Returns: boolean }
      lookup_auth_user_for_provisioning: {
        Args: { p_email: string }
        Returns: {
      ...
      pgrst_pre_request_check: { Args: never; Returns: undefined }
      ...
      set_invoice_status: {
        Args: { p_invoice_id: number; p_new_status: string }
        Returns: Json
      }
      shifts_match_current_user_station: {
        Args: { p_shift_id: number; p_station_id: number }
        Returns: boolean
      }
      ...
      validate_voucher_for_preview: {
        Args: { p_station_id: number; p_voucher_code: string }
        Returns: Json
      }
    }
    Enums: {
