 ...
 */
export function setSentryUser(user: { id: string | number; email: string; role: string }): void {
 ...
 * @param {import('@sentry/browser').SeverityLevel} level - Log level
 */
 ...
 * @param {Sentry.Breadcrumb} breadcrumb - Breadcrumb data
 */
